...
public class MinimumDegreeValue implements ValueOrderHeuristic<Integer, Cell, LatinSquareCsp> {
    private PriorityQueue<Integer> values;
    private LatinSquareCsp csp;
    private Cell variable;

    public MinimumDegreeValue() {
        values = null;
        csp = null;
        variable = null;
    }

    public MinimumDegreeValue(LatinSquareCsp csp, Cell variable) {
        setCsp(csp);
